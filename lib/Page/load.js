...
module.exports = function*() {
	...
	let browserScript = this.script ? `<script>"use strict";var _e='DOMContentLoaded';var _f=function(){document.removeEventListener(_e,_f);${components.script}};if(document.readyState!=='loading'){_f();}else{document.addEventListener(_e,_f);}</script>` : ''
