...
module.exports = function*() {
	...
	let browserScript = this.script ? `<script>"use strict";var _event='DOMContentLoaded';var _func=function(){document.removeEventListener(_event,_func);${components.script}};if(document.readyState==='complete'){_func();}else{document.addEventListener(_event,_func);}</script>` : ''
