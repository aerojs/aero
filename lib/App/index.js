...
Object.defineProperty(App.prototype, 'stylesSize', {
	get: function() {
		return this.css.map(element => element.code ? element.code.length : 0).reduce((a, b) => a + b)
	}
})

Object.defineProperty(App.prototype, 'scriptsSize', {
	get: function() {
		return this.js.map(element => element.code ? element.code.length : 0).reduce((a, b) => a + b)
	}
})
